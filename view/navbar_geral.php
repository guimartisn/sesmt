...
<nav  class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    <a class="navbar-brand" href="../view/assistente.php">SESMT</a>
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item" href="../controlador/consultar_ep.php">Consultar</a>
          <a class="dropdown-item" href="../controlador/ficha.php">Ficha Individual</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="../controlador/cadastro_usuario.php">Cadastrar Colaborador</a>
          <a class="dropdown-item" href="../controlador/consulta_usuario.php">Consultar Colaborador</a>
          <a class="dropdown-item" href="../controlador/gera_cert.php">Gerar Certificado</a>
        </div>
      </li>
